...
const beklememesaji = `Tekrar komut kullanabilmek için \`${sure}\` saniye kadar beklemelisin!` //Komut bekleme mesajı
...
module.exports = message => {
  ...
  if (cmd) {
    if (perms < cmd.conf.permLevel) return message.channel.send(':x: Maalesef yetkin yok!');
